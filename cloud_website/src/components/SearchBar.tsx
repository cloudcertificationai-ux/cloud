...
export default function SearchBar({ 
  ...
  return (
    <div ref={searchRef} className={`relative flex items-center ${className}`}>
      <form onSubmit={handleSubmit} className="relative flex h-9 w-full items-center">
        ...
        <input
          ...
          className="box-border block h-9 w-full rounded-full border border-gray-300 bg-white py-0 pl-9 pr-9 text-sm leading-9 text-slate-800 placeholder-gray-500 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500"
