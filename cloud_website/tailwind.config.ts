...
const config: Config = {
  ...
  theme: {
    extend: {
      // Simplilearn-inspired color palette
      colors: {
        ...
        // Accent colors - Teal/Green for success and CTAs
        accent: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
      ...
      fontSize: {
        ...
        'display-lg': ['3.75rem', { lineHeight: '4.25rem', fontWeight: '600' }],
      ...
      boxShadow: {
        ...
        'focus': '0 0 0 3px rgb(14 181 166 / 0.3)',
      },
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 5px rgb(14 181 166 / 0.5)' },
          '50%': { boxShadow: '0 0 20px rgb(14 181 166 / 0.8), 0 0 30px rgb(14 181 166 / 0.6)' },
        },
        shimmer: {
